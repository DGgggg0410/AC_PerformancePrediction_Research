...
def main():
    ...
    plt.tight_layout()
    output_dir = r'e:/Visual Studio Code2025/python_program/AC_PerformancePrediction_Research/AC_LSTM/output'
    plt.savefig(os.path.join(output_dir, 'lstm_ablation_comparison.png'), dpi=150)
    plt.close()

    print(f"\n对比图表已保存: {os.path.join(output_dir, 'lstm_ablation_comparison.png')}")
